...
### Bug Fixes
- **Light Mode**: Fixed a critical issue where the application would get stuck in dark mode; the app now correctly respects system themes and manual overrides.
